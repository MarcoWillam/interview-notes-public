...
- 代码：当前版本为 `/opt/interview-notes/releases/20260909-18`，`/opt/interview-notes/current` 已原子切到该目录；生产服务为 `interview-notes.service`，以专用 `interview-notes` 用户开机自启，仅监听 `127.0.0.1:8787`。上一稳定版本 `20260909-17` 保留用于回滚；`20260909-16` 为侧边栏高度修正前的中间版本，不作为回滚目标。
