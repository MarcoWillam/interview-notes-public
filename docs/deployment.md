...
本次版本提供 AI 产品经理（校招）与产品运营（校招）两个内置模板。运营按用户运营 60% / 数据增长 40% 组织证据，两岗都单列并重点考察自驱力。AI PM 笔试仅作为可选原则参考，不存具体题目，也不要求候选人必须有作品。简历阅读将完整本场标准发送给连接器，返回四类要点及六题、30–40 分钟的结构化面试提纲，每题包含合法模板维度、原文依据、原因、观察点与追问。
