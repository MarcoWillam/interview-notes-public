...
本地自动验证为 337 项测试，并通过类型检查、代码检查、生产构建和差异检查。浏览器在笔记本及窄屏断点验证固定候选人状态条、5 道必问、折叠候选题、8 行覆盖矩阵和任务中心，无横向溢出；虚构 AI 产品经理与产品运营材料均由真实本地 Codex 完成并通过服务端严格校验。发布候选包 SHA-256 为 `4e61a429a972e945abd50565b9a6fa4070b39d299ddac3e00ccbcf5687adcc25`，连接器包 SHA-256 为 `89a393cc8ded9d2942ab8fe9e0b1fc51848da21cd9548d056dd1e7db1fc499d2`。生产回滚目标为 `20260911-4`；部署后还需记录公网 HTTPS、Nginx、应用服务、SQLite 和最终 `current` 指向检查结果。
